...
# Generated by mac-hardening-netlib.sh v0.17
...
pass out quick proto { udp tcp } to 9.9.9.11
pass out quick proto { udp tcp } to 149.112.112.11
...
main() {
    ...
    while true; do
        ...
        echo "  ║  [4]  Reset network hardening            ║"
        ...
        case "$CHOICE" in
            ...
            3)
                ...
                ;;
            4)
                warn "[4] RESET: disabling PF DNS lock, Privoxy auto-switch, clearing proxies"
